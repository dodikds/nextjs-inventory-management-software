...
// Shared by searchProductsForSale (called from the client while the form is
// open) and the edit page — one query, multiple call sites, same as
// ../purchases/queries.ts's own getProductStockMap.
