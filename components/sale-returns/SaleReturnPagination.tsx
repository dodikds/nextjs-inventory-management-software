...
import { PER_PAGE_OPTIONS } from "@/app/(dashboard)/sales/returns/queries";
...
export default function SaleReturnPagination({ page, perPage, total }: SaleReturnPaginationProps) {
