...
import { PER_PAGE_OPTIONS } from "@/app/(dashboard)/peoples/suppliers/queries";
...
export default function SupplierPagination({ page, perPage, total }: SupplierPaginationProps) {
