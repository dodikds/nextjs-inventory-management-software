...
import { PER_PAGE_OPTIONS } from "@/app/(dashboard)/expense-categories/queries";

type ExpenseCategoryPaginationProps = {
  page: number;
  perPage: number;
  total: number;
};

export default function ExpenseCategoryPagination({ page, perPage, total }: ExpenseCategoryPaginationProps) {
