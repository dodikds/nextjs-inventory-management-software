...
import { PER_PAGE_OPTIONS } from "@/app/(dashboard)/purchases/returns/queries";
...
export default function PurchaseReturnPagination({ page, perPage, total }: PurchaseReturnPaginationProps) {
