...
import { PER_PAGE_OPTIONS } from "@/app/(dashboard)/product-categories/queries";
...
export default function CategoryPagination({ page, perPage, total }: CategoryPaginationProps) {
