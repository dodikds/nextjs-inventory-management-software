...
import { PER_PAGE_OPTIONS } from "@/app/(dashboard)/adjustments/queries";

type AdjustmentPaginationProps = {
  page: number;
  perPage: number;
  total: number;
};

export default function AdjustmentPagination({ page, perPage, total }: AdjustmentPaginationProps) {
