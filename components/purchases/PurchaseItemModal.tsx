...
export type PurchaseItemModalValues = {
  unitCost: string;
  taxType: TaxType;
  orderTax: string;
...
type PurchaseItemModalProps = {
  ...
  initialValues: PurchaseItemModalValues;
  onSave: (values: PurchaseItemModalValues) => void;
  onClose: () => void;
};

// design/Create Purchase.html's item-edit modal, opened by each Order
// items row's pencil icon. Edits are held in local draft state — nothing
// touches the row until Save, so Cancel/Escape/overlay-click can discard
// changes for free.
        ...
        <div className="gg-modal-body">
          ...
          <div className="gg-field">
            <label className="gg-label" htmlFor="itemUnit">
              Purchase Unit <span className="gg-req">*</span>
            </label>
            <select
              id="itemUnit"
              className="gg-select"
